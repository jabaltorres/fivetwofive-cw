...
if ( isset( $attributes['panelHoverHeadingColor'] ) && $attributes['panelHoverHeadingColor'] ) {
	$block_style[] = sprintf( '--ftfb-accordion-btn-hover-color: %1$s', $attributes['panelHoverHeadingColor'] );
}

if ( isset( $attributes['panelHoverHeadingBackgroundColor'] ) && $attributes['panelHoverHeadingBackgroundColor'] ) {
	$block_style[] = sprintf( '--ftfb-accordion-btn-hover-bg: %1$s', $attributes['panelHoverHeadingBackgroundColor'] );
}
...
$block_style[] = "text-align: {$attributes['textAlignment']}";
