 ...
 *
 * @author Carlos Rios
 * Modified by Danilo Parra for FiveTwoFive_Theme
 */
class Fivetwofive_Theme_CSS_PHP {
	...
	public function add_property( $property, $value, $unit = false ) {
		// If we don't have a value or Setting font-size to 0 is rarely ever a good thing, bail.
		if ( empty( $value ) || ( 'font-size' === $property && 0 === $value ) ) {
			return false;
		}
