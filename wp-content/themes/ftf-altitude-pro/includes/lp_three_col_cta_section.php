            ...
            <div class="container_inner">
                <div class="lp-cta-col">
                    <div class="lp-cta-col-inner">
                        ...
                        <a href="<?php echo $lp_cta_card_group['three_col_cta_group_card_1']['lp_cta_card_1_button_url']; ?>" class="button"><?php echo $lp_cta_card_group['three_col_cta_group_card_1']['lp_cta_card_1_button_text']; ?></a>
                    </div>
                </div>
                <div class="lp-cta-col">
                    <div class="lp-cta-col-inner">
                        ...
                        <a href="<?php echo $lp_cta_card_group['three_col_cta_group_card_2']['lp_cta_card_2_button_url']; ?>" class="button"><?php echo $lp_cta_card_group['three_col_cta_group_card_2']['lp_cta_card_2_button_text']; ?></a>
                    </div>
                </div>
                <div class="lp-cta-col">
                    <div class="lp-cta-col-inner">
                        ...
                        <a href="<?php echo $lp_cta_card_group['three_col_cta_group_card_3']['lp_cta_card_3_button_url']; ?>" class="button"><?php echo $lp_cta_card_group['three_col_cta_group_card_3']['lp_cta_card_3_button_text']; ?></a>
                    </div>
                </div>
            </div>
        </div>
