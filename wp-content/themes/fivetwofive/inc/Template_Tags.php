<?php
/**
 * Fivetwofive\FivetwofiveTheme\Template_Tags class
 *
 ...
 *
 * Its instance can be accessed through `fivetwofive()`. For example, if there is a template tag called `posted_on`, it can
