...
<h2 class="has-text-align-center has-x-large-font-size" id="pricing-table"><?php echo esc_html__( 'Pricing Table', 'fivetwofive' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'Create a four-column table, wide-width', 'fivetwofive' ); ?> (1200px).</p>
<!-- /wp:paragraph -->
...
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Personal', 'fivetwofive' ); ?> - $95</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-small-font-size"><?php echo esc_html__( 'Feature Item', 'fivetwofive' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background"><?php echo esc_html__( 'Sign Up Now', 'fivetwofive' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<div class="wp-block-group has-contrast-color has-base-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Professional', 'fivetwofive' ); ?> - $295</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"base"} -->
...
<div class="wp-block-group has-contrast-color has-base-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Enterprise', 'fivetwofive' ); ?> - $495</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"base"} -->
...
<div class="wp-block-group has-contrast-color has-base-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Ultimate', 'fivetwofive' ); ?> - $995</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"base"} -->
