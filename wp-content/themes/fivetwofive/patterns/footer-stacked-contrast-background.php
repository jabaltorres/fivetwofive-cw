 ...
 * Slug: fivetwofive/footer-stacked-contrast-background
...
<h2 class="has-text-align-center has-max-48-font-size" id="let-s-connect" style="font-style:normal;font-weight:400;margin-bottom:20px"><?php echo esc_html__( 'Let’s Connect', 'fivetwofive' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline-base"><a class="wp-block-button__link" href="#"><?php echo esc_html__( 'Get in Touch', 'fivetwofive' ); ?> →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
<p class="has-text-align-center has-small-font-size">© <?php echo esc_html( gmdate( 'Y' ) ); ?> Your Company LLC · <a href="#"><?php echo esc_html__( 'Contact Us', 'fivetwofive' ); ?></a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
