 ...
 * Slug: fivetwofive/footer-default-contrast-background
...
<!-- wp:paragraph -->
<p>© <?php echo esc_html( gmdate( 'Y' ) ); ?> Your Company LLC · <a href="#"><?php echo esc_html__( 'Contact Us', 'fivetwofive' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
