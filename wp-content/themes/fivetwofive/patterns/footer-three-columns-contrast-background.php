 ...
 * Slug: fivetwofive/footer-three-columns-contrast-background
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'fivetwofive' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'fivetwofive' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'fivetwofive' ); ?></a></p>
<!-- /wp:paragraph -->
