 ...
 * Slug: fivetwofive/footer-stacked
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link" href="#"><?php echo esc_html__( 'Get in Touch', 'fivetwofive' ); ?> →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
