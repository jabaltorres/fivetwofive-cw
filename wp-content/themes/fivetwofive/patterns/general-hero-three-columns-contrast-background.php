<?php
/**
 * Title: Section three columns - contrast background
 * Slug: fivetwofive/general-hero-three-columns-contrast-background
...
<div class="wp-block-group alignfull has-background-color has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0px;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px"><!-- wp:heading {"textAlign":"center","fontSize":"max-48"} -->
	<h2 class="wp-block-heading has-text-align-center has-max-48-font-size" id="image-heading-text-button">Image, heading, text, button.</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide"><!-- wp:column -->
		<div class="wp-block-column"><!-- wp:image {"id":242,"sizeSlug":"full","linkDestination":"none"} -->
			<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample-white_1200x1200.jpg'; ?>" alt="Sample Image" class="wp-image-242"/></figure>
			<!-- /wp:image -->

			<!-- wp:heading {"textAlign":"center","level":3} -->
			<h3 class="wp-block-heading has-text-align-center" id="sample-heading-1">Sample Heading</h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column"><!-- wp:image {"id":242,"sizeSlug":"full","linkDestination":"none"} -->
			...
			<!-- wp:heading {"textAlign":"center","level":3} -->
			<h3 class="wp-block-heading has-text-align-center" id="sample-heading-2">Sample Heading</h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column"><!-- wp:image {"id":242,"sizeSlug":"full","linkDestination":"none"} -->
			...
			<!-- wp:heading {"textAlign":"center","level":3} -->
			<h3 class="wp-block-heading has-text-align-center" id="sample-heading-3">Sample Heading</h3>
			<!-- /wp:heading -->
