 ...
 * Genesis FiveTwoFive.
 *
 * This file adds the required WooCommerce setup functions to the Genesis FiveTwoFive Theme.
 *
...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'genesis_fivetwofive_woocommerce_breakpoint' );
/**
 ...
 */
function genesis_fivetwofive_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'genesis_fivetwofive_default_products_per_page' );
/**
 ...
 */
function genesis_fivetwofive_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'genesis_fivetwofive_woocommerce_pagination' );
/**
 ...
 */
function genesis_fivetwofive_woocommerce_pagination( $args ) {

	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'genesis-fivetwofive' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'genesis-fivetwofive' ) );

	return $args;

}

add_action( 'after_switch_theme', 'genesis_fivetwofive_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function genesis_fivetwofive_woocommerce_image_dimensions_after_theme_setup() {
	...
	genesis_fivetwofive_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'genesis_fivetwofive_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function genesis_fivetwofive_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function genesis_fivetwofive_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'genesis_fivetwofive_gallery_image_thumbnail' );
/**
 ...
 */
function genesis_fivetwofive_gallery_image_thumbnail( $size ) {
