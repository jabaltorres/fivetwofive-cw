...
add_action( 'wp_enqueue_scripts', 'genesis_fivetwofive_enqueue_gutenberg_frontend_styles' );
/**
 * Enqueues Gutenberg front-end styles.
 *
 * @since 2.7.0
 */
function genesis_fivetwofive_enqueue_gutenberg_frontend_styles() {
...
add_action( 'enqueue_block_editor_assets', 'genesis_fivetwofive_block_editor_styles' );
/**
 * Enqueues Gutenberg admin editor fonts and styles.
 *
 * @since 2.7.0
 */
function genesis_fivetwofive_block_editor_styles() {
...
add_filter( 'body_class', 'genesis_fivetwofive_blocks_body_classes' );
/**
 ...
 */
function genesis_fivetwofive_blocks_body_classes( $classes ) {
...
$genesis_fivetwofive_appearance = genesis_get_config( 'appearance' );

// Adds support for editor font sizes.
add_theme_support(
	'editor-font-sizes',
	$genesis_fivetwofive_appearance['editor-font-sizes']
);

// Adds support for editor color palette.
add_theme_support(
	'editor-color-palette',
	$genesis_fivetwofive_appearance['editor-color-palette']
);

require_once get_stylesheet_directory() . '/lib/gutenberg/inline-styles.php';

add_action( 'after_setup_theme', 'genesis_fivetwofive_content_width', 0 );
/**
 * Set content width to match the “wide” Gutenberg block width.
 */
function genesis_fivetwofive_content_width() {
