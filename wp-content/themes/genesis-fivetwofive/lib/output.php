 ...
 * Genesis FiveTwoFive.
 *
 * This file adds the required CSS to the front end to the Genesis FiveTwoFive Theme.
 *
...
add_action( 'wp_enqueue_scripts', 'genesis_fivetwofive_css' );
/**
 ...
 * @since 2.2.3
 */
function genesis_fivetwofive_css() {
