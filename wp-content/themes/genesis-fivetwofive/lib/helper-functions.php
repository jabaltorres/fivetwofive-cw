 ...
 * Genesis FiveTwoFive.
 *
 * This file adds the required helper functions used in the Genesis FiveTwoFive Theme.
 *
 ...
 */
function genesis_fivetwofive_color_contrast( $color ) {
 ...
 */
function genesis_fivetwofive_color_brightness( $color, $change ) {
